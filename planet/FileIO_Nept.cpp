...
void cNeptuneModel::writeData(){
    cout << endl << "      ATNEPT: writeData" << endl;
...
//        paraview_sphere_vts(iter_n);
    ...
    cout << "      ATNEPT: writeData ended" << endl;
...
*
*/
void cNeptuneModel::writeResults(){
    cout << endl << "      ATNEPT: writeResults" << endl;
...
*/
    ...
    cout << "      ATNEPT: writeResults ended" << endl;
