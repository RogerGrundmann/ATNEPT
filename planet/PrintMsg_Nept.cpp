...
cout << "   " << i_t << "   " << j_t << "   " << k_t << "   " << max_t << "   " << min_t << endl;
    ...
    cout << endl << endl;
    cout << "      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>    3D    <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<" << endl;
    cout << "      3D ATNEPT iterational process" << endl;
